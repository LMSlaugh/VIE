...
data = client.get_stream_by_point(points, calculation="calculated", start="2019-01-01 00:00:00", end="2019-10-28 00:00:00",interval="5m")
#data = client.get_stream_by_point(points, calculation="end")

data.to_csv("DataFiles\\RMI_BWFP_5min_Demand_2019.csv", header=True, index=True)
