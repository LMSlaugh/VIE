...
def GenerateAccuracyCurves(metrics_vthresh, thresh, params):
    ...
    #ax[0,0].set_xlabel("Threshold for Vacancy/Occupancy Determination (%)", fontsize=labs)
    ...
    #ax[0,1].set_ylabel("COR/MOR: FP/FN", fontsize=labs)
    #ax[0,1].set_xlabel("Threshold for Vacancy/Occupancy Determination (%)", fontsize=labs)
    ...
    #ax[1,1].set_ylabel("COR/MOR: FP/FN", fontsize=labs)
    ...
    #ax.grid(b=True, which='major', color='#666666', linestyle='-', linewidth=1, alpha=0.7)
    #ax.grid(b=True, which='minor', color='#999999', linestyle='-', linewidth=1, alpha=0.2)
    #ax.set_title("COR/MOR < 20 vs. Threshold", fontsize=titlesz, fontweight="bold")
    ...
    #ax.grid(b=True, which='major', color='#666666', linestyle='-', linewidth=1, alpha=0.7)
    #ax.grid(b=True, which='minor', color='#999999', linestyle='-', linewidth=1, alpha=0.2)
    #ax.set_title("COR/MOR < 5 vs. Threshold", fontsize=titlesz, fontweight="bold")
    #ax.set_ylabel("COR/MOR: FP/FN", fontsize=labs)
    #ax.set_xlabel("Threshold for Vacancy/Occupancy Determination (%)", fontsize=labs)
    ...
    #ax.grid(b=True, which='major', color='#666666', linestyle='-', linewidth=1, alpha=0.7)
    #ax.grid(b=True, which='minor', color='#999999', linestyle='-', linewidth=1, alpha=0.2)
    #ax.set_title("COR/MOR < 1 vs. Threshold", fontsize=titlesz, fontweight="bold")
    #ax.set_ylabel("COR/MOR: FP/FN", fontsize=labs)
    #ax.set_xlabel("Threshold for Vacancy/Occupancy Determination (%)", fontsize=labs)
    ...
    #ax.grid(b=True, which='major', color='#666666', linestyle='-', linewidth=1, alpha=0.7)
    #ax.grid(b=True, which='minor', color='#999999', linestyle='-', linewidth=1, alpha=0.2)
    #ax.set_title("COF/MOF vs. Threshold", fontsize=titlesz, fontweight="bold")
    #ax.set_ylabel("COF/MOF: FP(TP + FN)/FN(TP + TN + FN + FP)", fontsize=labs)
    #ax.set_xlabel("Threshold for Vacancy/Occupancy Determination (%)", fontsize=labs)
