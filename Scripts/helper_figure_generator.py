...
def PlotHistoricalOuts(historicaldata):
    ...
    ax.plot(historicaldata["overallprobadt"], historicaldata["overallprobaval"], "k.", label="Fused (%)")
    plt.ylim([0,1])
    ax.legend(loc='best', fontsize=legs)
...
def PlotHistoricalInOuts(historicaldata):
    ...
    ax[1].plot(historicaldata["overallprobadt"], historicaldata["overallprobaval"], "k.", label="Fused (%)")
    plt.ylim([0,1])
...
def PlotOutputComparison(historicaldata, realtimedata):
    ...
    ax.plot(historicaldata["overallprobadt"], historicaldata["overallprobaval"], "c", label="Historical (%)")
    ax.plot(realtimedata["overallprobadt"], realtimedata["overallprobaval"], "m", label="Real-time (%)")
    plt.ylim([0,1])
    ax.legend(loc='best', fontsize=legs)
